export default class Legend {
        ...
        for (let i = 0; i < styleNames.length; i++) {
            ...
            switch (style) {
                ...
                case "UK-USA-totalStudent-point-19to20-ave":
                    ...
                    break;
                case "studyAbroad_top10_polygon":
                    this.createStudyAbroad_top10_polygonLegend();
                    break;
    ...
    createStudyAbroad_top10_polygonLegend(){
        console.log("createStudyAbroad_top10_polygonLegend");
        let addTitle = document.createElement('h1');
        addTitle.innerHTML = "世界最佳留学国分布图";
        title.appendChild(addTitle);

        let color = ["#037382", "#3297a4", "#76c4d0", "#a6d1d8", "#d0e3e6"];
        let valueA = ["rank 1","rank 3","rank 5","rank 7","rank 9"];
